 ...
 *
 *    2，要求：向Set中添加的数据，其所在的类一定要重写equals()和hashCode()方法，尽可能保持一致性：相等的对象必须具有相等的散列码
...
public class SetTest {
    ...
    * 一，Set：存储无序的，不可重复的数据
     ...
     *优点：对于频繁的遍历操作，LinkedHashSet效率比HashSet高
     */
    @Test
    public void test2() {
